<%-- 
    Document   : body
    Created on : Aug 11, 2020, 9:04:00 PM
    Author     : Saiful
--%>
                                    ...
                                    <div class="tp-banner tp-banner0">
                                        <ul>
                                            ...
                                            <li data-link="#" data-target="_self" data-transition="flyin" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                <!-- MAIN IMAGE --><img src="img/slide/dummy.png" alt="slidebg1" data-lazyload="img/slide/slider4.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                <!-- LAYER NR. 1 -->
                                            ...
                                            <li data-link="#" data-target="_self" data-transition="3dcurtain-horizontal" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                <!-- MAIN IMAGE --><img src="img/slide/dummy.png" alt="slidebg1" data-lazyload="img/slide/slider2.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                <!-- LAYER NR. 1 -->
                                            ...
                                            <li data-transition="boxslide" data-slotamount="7" data-masterspeed="500" data-saveperformance="on">
                                                <!-- MAIN IMAGE --><img src="img/slide/dummy.png" alt="slidebg1" data-lazyload="img/slide/slide_3.jpg" data-bgposition="left center" data-kenburns="off" data-duration="14000" data-ease="Linear.easeNone" data-bgpositionend="right center" />
                                                <!-- LAYER NR. 1 -->
        ...
        <div class="container">
            ...
            <div class="shopping-content">
                ...
                <div class="block-heading-two">
                    <h3><span>Food Items</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<button style="align-content: center" href="#">See All</button></h3>
                </div>

                <div class="row">

                    <c:forEach var="pd" items="${foodproductlist}">
                        ...
                        <div class="col-md-3 col-sm-6">
                            ...
                            <div class="shopping-item">
                                ...
                                <a href="single-product?id=<c:out value='${pd.id}'/>"><img   class="img-responsive" src="img/fimg1000/${pd.image}" alt="" /></a>
                                <!-- Shopping item name / Heading -->
                                <h4><a href="single-product?id=<c:out value='${pd.id}'/>">${pd.product_name}</a><span class="color pull-right">${pd.new_price} Tk</span></h4>
                                <div class="clearfix"></div>
                                <!-- Buy now button -->
                                <div class="visible-xs">
                                    <a class="btn btn-color btn-sm"id="id_${pd.id}"  onclick="addtocart11(${pd.id}); return false">Buy Now</a>
                                </div>
                                <!-- Shopping item hover block & link -->
                                <div class="item-hover bg-color hidden-xs">
                                    <!--<a href="addtoCart?cartid=< c:out value='$ { pd.id}'/>">Add to cart</a>-->   
                                    <a href="" id="id_${pd.id}"  onclick="addtocart11(${pd.id}); return false">Add to cart</a>   
                                    <!--<input  id="id_$ {pd.id}"  onclick="addtocart11($ {pd.id}); return false" value="Add to cart"/>--> 
                                </div>

                                <div class="item-hover2 bg-color hidden-xs">  
                                    <a href="#" >See all Product</a>
                                    <!--<button style="background-color: #32c8de !important;" onclick="addtocart11($ {pd.id})">See all Product</button>-->
                                    <script></script>
                                    <!--<input id="" style="background-color: #32c8de !important;" type="submit"  value="See all Product"/>-->
                                </div>
                                <div class="item-hover3 bg-color hidden-xs">
...
<!--                        <li class="disabled"><a href="#">&laquo;</a></li>
                        ...
                        <li><a href="${paramitar}?pageid=1">1</a></li>
                        <li><a href="${paramitar}?pageid=2">2</a></li>
                        <li><a href="${paramitar}?pageid=3">3</a></li>
                        <li><a href="${paramitar}?pageid=4">4</a></li>
                                        ...
                                        <div class="product  item first ">
                                            ...
                                            <article>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption><span class="amount">20.00 TK</span></figcaption>
                                                </figure>
                                        ...
                                        <div class="product  item first ">
                                            ...
                                            <article>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption><span class="amount">35.00 TK</span></figcaption>
                                                </figure>
                                        ...
                                        <div class="product  item first ">
                                            ...
                                            <article>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption>
                                                        <span class="amount">20.00 TK</span></figcaption>
                                                </figure>
                                        ...
                                        <div class="product  item first ">
                                            ...
                                            <article>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption><span class="amount">18.00 TK</span></figcaption>
                                                </figure>
                                        ...
                                        <div class="product  item first ">
                                            ...
                                            <article>
                                                ...
                                                <figure>
                                                    ...
                                                    <figcaption><span class="amount">35.00TK</span></figcaption>
                                                </figure>
    ...
    <div class="bt-block-home-parallax" style="background-image: url(img/resource/resource.jpg);">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="lookbook-product">
                        <h2><a href="#" title="">Saiful's Collection 2020 </a></h2>
            ...
            <div class="row">
                    ...
                    <div class="Last-post">
                        <ul class="shop-res-items">
                            <li>
                                ...
                                <h6><a href="#">Shushi With Meoness</a></h6>
                                <span class="sale-date">$28.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/54.jpg" alt=""></a>
                                <h6><a href="#">Testy Pesty Cake</a></h6>
                                <span class="sale-date">$40.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/55.jpg" alt=""></a>
                                <h6><a href="#">Jame cake with Dhuma</a></h6>
                                <span class="sale-date">$150.00</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="Last-post">
                        <ul class="shop-res-items">
                            <li>
                                ...
                                <h6><a href="#">Faluda Serice</a></h6>
                                <span class="sale-date">$28.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/57.jpg" alt=""></a>
                                <h6><a href="#">Beautiful Sofa set</a></h6>
                                <span class="sale-date">$40.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/58.jpg" alt=""></a>
                                <h6><a href="#">Beautiful Jump ckerce</a></h6>
                                <span class="sale-date">$150.00</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="Last-items-shop col-md-3 col-sm-6">
                    ...
                    <div class="Last-post">
                        <ul class="shop-res-items">
                            <li>
                                <a href="#"><img src="img/small/59.jpg" alt=""></a>
                                <h6><a href="#">Beautiful Vanity bag</a></h6>
                                <span class="sale-date">$28.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/60.jpg" alt=""></a>
                                <h6><a href="#">Gulistan Watch</a></h6>
                                <span class="sale-date">$40.00</span>
                            </li>
                            <li>
                                <a href="#"><img src="img/small/61.jpg" alt=""></a>
                                <h6><a href="#">Beautiful Jence with Fara Stayl</a></h6>
                                <span class="sale-date">$150.00</span>
                            </li>
                        </ul>
                    </div>
