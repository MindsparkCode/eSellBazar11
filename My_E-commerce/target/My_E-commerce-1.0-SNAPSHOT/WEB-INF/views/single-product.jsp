                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-sm-6 summary-before ">
                                        ...
                                        <div class="product-slider product-shop">
                                            ...
                                            <ul class="slides">
                                                <li data-thumb="img/fimg1000/${product.image}">
                                                <!--<li data-thumb="img/temp-images/vv/Burger-140x140.jpg">-->
                                                    <a href="img/fimg1000/${product.image}" data-imagelightbox="gallery" class="hoodie_7_front">
                                                    <!--<a href="img/temp-images/vv/Burger.jpg" data-imagelightbox="gallery" class="hoodie_7_front">-->
                                                        <img src="img/fimg1000/${product.image}" class="attachment-shop_single" alt="image">
                                                        <!--<img src="img/temp-images/vv/Burger-470x470.jpg" class="img-responsive" alt="image">-->
                                                    </a>
                                                </li>
                                                <li data-thumb="img/bimg1000/${product.image}">
                                                <!--<li data-thumb="img/temp-images/vv/Burger_back-140x140_1.jpg">-->
                                                    <a href="img/bimg1000/${product.image}" data-imagelightbox="gallery" class="hoodie_7_back">
                                                    <!--<a href="img/temp-images/vv/Burger_back.jpg" data-imagelightbox="gallery" class="hoodie_7_back">-->
                                                        <img src="img/bimg1000/${product.image}" class="attachment-shop_single" alt="image">
                                                        <!--<img src="img/temp-images/vv/Burger_back-470x470.jpg" class="img-responsive" alt="image">-->
                                                    </a>
                                                </li>
                                    ...
                                    <div class="col-sm-6 col-md-7 product-review entry-summary">
                                        ...
                                        <div>
                                            <p class="price"><del><span class="amount">${product.old_price}</span></del>
                                                <ins><span class="amount">${product.new_price}</span></ins></p>
                                        </div>
                                        ...
                                        <div class="product_meta">
                                            ...
                                            <span class="sku_wrapper">Brand: <span class="sku">${product.company}</span>.</span>


                                            <span class="posted_in">Categories: <a href="#" rel="tag">${product.category}</a>, <a href="#">Hoodies</a>.</span>
